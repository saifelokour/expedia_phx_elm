...
require.register("elm/Components/Hotel.elm", function(exports, require, module) {

});

;require.register("elm/Components/Offers.elm", function(exports, require, module) {
...
(function () {
	...
	var _user$project$Hotel$decodeHotelInfo = A4(_elm_lang$core$Json_Decode$map3, _user$project$Hotel$HotelInfo, A2(_elm_lang$core$Json_Decode$at, {
		ctor: '::',
		_0: 'hotelName',
		_1: { ctor: '[]' }
	}, _elm_lang$core$Json_Decode$string), A2(_elm_lang$core$Json_Decode$at, {
	...
	var _user$project$Hotel$decodeHotelUrls = A2(_elm_lang$core$Json_Decode$map, _user$project$Hotel$HotelUrls, A2(_elm_lang$core$Json_Decode$at, {
		ctor: '::',
		_0: 'hotelInfositeUrl',
		_1: { ctor: '[]' }
	}, _elm_lang$core$Json_Decode$string));
	...
	var _user$project$Components_Offers$decodeHotelData = A7(_elm_lang$core$Json_Decode$map6, _user$project$Hotel$Model, A2(_elm_lang$core$Json_Decode$at, {
		...
		_0: 'hotelInfo',
		_1: { ctor: '[]' }
	}, _user$project$Hotel$decodeHotelInfo), A2(_elm_lang$core$Json_Decode$at, {
		ctor: '::',
		_0: 'hotelUrls',
		_1: { ctor: '[]' }
	...
	var _user$project$Components_Offers$decodeOffersFetch = A2(_elm_lang$core$Json_Decode$at, {
		ctor: '::',
		_0: 'offers',
		_1: { ctor: '[]' }
	}, _user$project$Components_Offers$decodeHotelsFetch);
	var _user$project$Components_Offers$Model = function _user$project$Components_Offers$Model(a) {
		return { offers: a };
	};
	var _user$project$Components_Offers$UpdateOffers = function _user$project$Components_Offers$UpdateOffers(a) {
		return { ctor: 'UpdateOffers', _0: a };
	};
	var _user$project$Components_Offers$fetchOffers = function () {
		var url = '/api/offers';
		return A2(_elm_lang$http$Http$send, _user$project$Components_Offers$UpdateOffers, A2(_elm_lang$http$Http$get, url, _user$project$Components_Offers$decodeOffersFetch));
	}();
	var _user$project$Components_Offers$update = F2(function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
	...
	var _user$project$Main$OffersMsg = function _user$project$Main$OffersMsg(a) {
	...
	var _user$project$Main$update = F2(function (msg, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(model, { offerListModel: updatedModel }),
	...
	var _user$project$Main$view = function _user$project$Main$view(model) {
		return A2(_elm_lang$html$Html$div, {
			...
			ctor: '::',
			_0: A2(_elm_lang$html$Html$map, _user$project$Main$OffersMsg, _user$project$Components_Offers$view(model.offerListModel)),
			_1: { ctor: '[]' }
		});
	};
	var _user$project$Main$main = _elm_lang$html$Html$program({ init: _user$project$Main$init, view: _user$project$Main$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions })();
